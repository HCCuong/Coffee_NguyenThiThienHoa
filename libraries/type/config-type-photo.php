...
// $config['photo']['photo_static'][$nametype]['width'] = 270;
// $config['photo']['photo_static'][$nametype]['height'] = 220;
...
$config['photo']['man_photo'][$nametype]['link_photo'] = true;
$config['photo']['man_photo'][$nametype]['name_photo'] = true;
$config['photo']['man_photo'][$nametype]['width_photo'] = 540;
$config['photo']['man_photo'][$nametype]['height_photo'] = 540;
$config['photo']['man_photo'][$nametype]['thumb_photo'] = '200x100x1';
$config['photo']['man_photo'][$nametype]['img_type_photo'] = '.jpg|.gif|.png|.jpeg|.gif';
...
$config['photo']['man_photo'][$nametype]['height_photo'] = 105;
$config['photo']['man_photo'][$nametype]['thumb_photo'] = '200x100x1';
$config['photo']['man_photo'][$nametype]['img_type_photo'] = '.jpg|.gif|.png|.jpeg|.gif';

/* Slideshow quảng cáo */
$nametype = "slide-ads";
$config['photo']['man_photo'][$nametype]['title_main_photo'] = "Slideshow quảng cáo";
$config['photo']['man_photo'][$nametype]['check_photo'] = array("hienthi" => "Hiển thị");
$config['photo']['man_photo'][$nametype]['number_photo'] = 4;
$config['photo']['man_photo'][$nametype]['images_photo'] = true;
$config['photo']['man_photo'][$nametype]['avatar_photo'] = true;
